 ...
 * @version		$Id:$
 */
class Lib_Io_JsonRpc_ServiceLocator
{



    /**
     * @var Lib_Io_JsonRpc_Filter_ClassMethod
     */
    ...
    public function findServiceClassByDestination($destination)
    {
        ...
        $destinationFilter = new Lib_Io_JsonRpc_Filter_Destination();
        ...
        if ($preferredVersion>$minVersion) {
            for ($i= $preferredVersion; $i>0; $i--) {
                ...
                if (class_exists($classNameFinal))  {
                    ...
                    $filterService = new Lib_Io_JsonRpc_Filter_Service();
    ...
    {
        $classMethodFilter = new Lib_Io_JsonRpc_Filter_ClassMethod();
