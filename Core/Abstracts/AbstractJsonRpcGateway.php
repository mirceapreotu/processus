...
namespace Core\Abstracts
{
    ...
    abstract class AbstractJsonRpcGateway extends Server
    {
        ...
        {
            if (! empty($this->_config['validDomains']) &&
             in_array($this->_domain, $this->_config['validDomains'])) {
                return TRUE;
            }
        ...
        {
            if ($this->isEnabled() && $this->hasNamespace() &&
             $this->isValidDomain()) {
                return TRUE;
            }
        ...
        public function getServer ()
        {
            ...
            return new $server($this->_request, $this->_config['namespace'], 
            $this->_domain, $this->_class);
        }
