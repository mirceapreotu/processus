 ...
 */
class Pheanstalk_Command_ReserveCommand extends Pheanstalk_Command_AbstractCommand implements 
Pheanstalk_ResponseParser
{
    ...
    {
        return isset($this->_timeout) ? sprintf('reserve-with-timeout %s', 
        $this->_timeout) : 'reserve';
    }
    ...
    public function parseResponse ($responseLine, $responseData)
    {
        ...
        array('id' => (int) $id, 'jobdata' => $responseData));
    }
}
