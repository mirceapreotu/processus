...
use Zend\Db, Zend\Db\Adapter, Zend\Db\Adapter\AbstractPdoAdapter;
...
class Sqlite extends \Zend\Db\Adapter\AbstractPdoAdapter
{
    ...
    'INTEGER' => Db\Db::BIGINT_TYPE, 'REAL' => Db\Db::FLOAT_TYPE);
    ...
    public function describeTable ($tableName, $schemaName = null)
    {
        ...
        foreach ($result as $key => $row) {
            ...
            'DATA_TYPE' => $row[$type], 'DEFAULT' => $row[$dflt_value], 
            'NULLABLE' => ! (bool) $row[$notnull], 'LENGTH' => $length, 
