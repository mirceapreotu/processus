...
class Acl
{
    ...
    'allResources' => array(
    'allRoles' => array(
    'allPrivileges' => array('type' => self::TYPE_DENY, 'assert' => null), 
    ...
    public function addResource ($resource, $parent = null)
    {
        ...
        $this->_resources[$resourceId] = array('instance' => $resource, 
        'parent' => $resourceParent, 'children' => array());
    ...
    $privileges = null, Assertion $assert = null)
    {
        ...
        if (! is_array($resources)) {
            $resources = ($resources == null && count($this->_resources) > 0) ? array_keys(
            $this->_resources) : array($resources);
        } else 
    ...
    public function isAllowed ($role = null, $resource = null, $privilege = null)
    {
        ...
        if (null === $privilege) {
            ...
            do {
                ...
                if (null !== $role &&
                 null !==
                 ($result = $this->_roleDFSOnePrivilege($role, $resource, 
                $privilege))) {
                    return $result;
                }
                ...
                if (null !==
                 ($ruleType = $this->_getRuleType($resource, null, $privilege))) {
     ...
     * @return boolean|null
     */
    protected function _roleDFSAllPrivileges (Role $role, 
     ...
     */
    protected function _roleDFSVisitAllPrivileges (Role $role, 
    Resource $resource = null, &$dfs = null)
    {
        if (null === $dfs) {
        ...
        if (null !== ($rules = $this->_getRules($resource, $role))) {
            ...
            if (null !==
             ($ruleTypeAllPrivileges = $this->_getRuleType($resource, $role, 
            null))) {
                return self::TYPE_ALLOW === $ruleTypeAllPrivileges;
            }
        }
     ...
     * @throws Zend\Acl\Exception\RuntimeException
     */
    protected function _roleDFSOnePrivilege (Role $role, 
     ...
     * @throws Zend\Acl\Exception\RuntimeException
     */
    protected function _roleDFSVisitOnePrivilege (Role $role, 
    Resource $resource = null, $privilege = null, &$dfs = null)
    {
        if (null === $privilege) {
            /**
     ...
     * @return string|null
     */
    protected function _getRuleType (Resource $resource = null, Role $role = null, 
    $privilege = null)
    {
     ...
     * @return array|null
     */
    protected function &_getRules (Resource $resource = null, Role $role = null, 
    $create = false)
    {
