...
use Zend\Loader\ShortNameLocator, Zend\Loader\PrefixPathLoader, Zend\Loader\PrefixPathMapper, Zend\Loader\Exception\PluginLoaderException;
...
class Writer
{
     ...
     * @var array
     */
    protected static $_extensions = array('entry' => array(), 
    'feed' => array(), 'entryRenderer' => array(), 'feedRenderer' => array());
    ...
    public static function getPluginLoader ()
    {
        if (! isset(self::$_pluginLoader)) {
            self::$_pluginLoader = new PrefixPathLoader(
            array(
    ...
    public static function reset ()
    {
        ...
        self::$_extensions = array('entry' => array(), 'feed' => array(), 
        'entryRenderer' => array(), 'feedRenderer' => array());
    }
