    ...
    class Bootstrap
    {
        ...
        public static function init($mode = 'DEFAULT')
        {
            try
            {
                ...
                set_error_handler(array('Core\Bootstrap', 'handleError'));
                register_shutdown_function(array('Core\Bootstrap', 'handleError'));
                ...
                // setup autoloader
                spl_autoload_register(array('Core\Bootstrap', '_autoLoad'));
        ...
        public static function _autoLoad($className)
        {
            ...
            // root exceptions
            if(strpos($className, 'Core\Bootstrap'))
            {
                $className = 'Bootstrap';
            }
            elseif(strpos($className, 'Core\Registry'))
            {
                $className = 'Registry';
            }
            elseif(strpos($className, 'Core\Application'))
            {
