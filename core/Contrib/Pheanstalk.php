 ...
 */
namespace Processus\Contrib\Pheanstalk {
    class Pheanstalk
    {
        ...
        {
            $this->setConnection(
                new Pheanstalk_Connection($host, $port, $connectTimeout));
        }
        ...
        {
            $response = $this->_dispatch(new Pheanstalk_Command_PeekCommand($jobId));
        ...
        {
            $response = $this->_dispatch(
                new Pheanstalk_Command_PeekCommand(
         ...
         */
        public function put($data, $priority = self::DEFAULT_PRIORITY, $delay = self::DEFAULT_DELAY,
