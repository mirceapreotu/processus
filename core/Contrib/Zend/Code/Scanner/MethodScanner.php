...
use Zend\Code\Scanner, Zend\Code\NameInformation, Zend\Code\Exception, Zend\Code\Annotation;
...
class MethodScanner implements Scanner
{
    ...
    public function getParameter ($parameterNameOrInfoIndex)
    {
        ...
        $info['tokenEnd'] - $info['tokenStart']), $this->nameInformation);
    ...
    protected function scan ()
    {
        ...
        &$tokenLine)
        {
            $infos[$infoIndex] = array('type' => 'parameter', 
            'tokenStart' => $tokenIndex, 'tokenEnd' => null, 
            'lineStart' => $tokenLine, 'lineEnd' => $tokenLine, 
            'name' => null, 'position' => $infoIndex + 1)// position is +1 of infoIndex
;
        };
