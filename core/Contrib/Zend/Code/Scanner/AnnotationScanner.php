...
use Zend\Code\Scanner, Zend\Code\NameInformation, Zend\Code\Annotation\AnnotationManager, Zend\Code\Annotation\AnnotationCollection;
    ...
    protected function scan (array $tokens)
    {
        ...
        foreach ($annotations as $annotation) {
            if ($this->annotationManager->hasAnnotation($annotation[0])) {
                $this->append(
                $this->annotationManager->createAnnotation($annotation[0], 
                trim($annotation[1], '()')));
            }
        }
    }
