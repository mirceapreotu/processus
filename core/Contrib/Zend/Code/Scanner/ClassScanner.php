...
use Zend\Code\Scanner, Zend\Code\NameInformation, Zend\Code\Annotation\AnnotationManager, Zend\Code\Exception;
...
class ClassScanner implements Scanner
{
    ...
    public function getMethod ($methodNameOrInfoIndex)
    {
        ...
        $info['tokenEnd'] - $info['tokenStart'] + 1), $this->nameInformation);
        ...
        if ($tokenType === null && $tokenContent === '{' && $braceCount === 0) {
            ...
            switch ($tokenType) {
                ...
                case T_CONST:
                    ...
                    $infos[$infoIndex] = array('type' => 'constant', 
                    'tokenStart' => $tokenIndex, 'tokenEnd' => null, 
                    'lineStart' => $tokenLine, 'lineEnd' => null, 
                ...
                case T_FUNCTION:
                    ...
                    $infos[$infoIndex] = array('type' => null, 
                    'tokenStart' => $tokenIndex, 'tokenEnd' => null, 
                    'lineStart' => $tokenLine, 'lineEnd' => null, 
                    'name' => null);
                    ...
                    if ($memberContext !== null) {
                        if (($memberContext === 'property' &&
                         $tokenContent === ';') ||
                         ($memberContext === 'method' && $methodBodyStarted &&
                         $braceCount === 1) ||
                         ($memberContext === 'method' && $this->isInterface &&
                         $tokenContent === ';')) {
