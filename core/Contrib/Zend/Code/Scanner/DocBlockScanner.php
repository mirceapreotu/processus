...
use Zend\Code\Scanner, Zend\Code\NameInformation, Zend\Code\Annotation\AnnotationManager;
    ...
    protected function tokenize ()
    {
        ...
        &$annotationMode)
        {
            ...
            if ($currentChar === ' ') {
                ...
                if ($annotationMode) {
                    $currentWord = (($matches = strpos($currentLine, ' ')) !==
                     false) ? substr($currentLine, 0, $matches) : $currentLine;
                } else {
