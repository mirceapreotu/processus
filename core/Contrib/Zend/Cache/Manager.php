...
class Manager
{
    ...
    'skeleton' => array(
    'frontend' => array('name' => null, 'options' => array()), 
    'backend' => array('name' => null, 'options' => array())), 
    // Simple Common Default
    'default' => array(
    'frontend' => array('name' => 'Core', 
    'options' => array('automatic_serialization' => true)), 
    'backend' => array('name' => 'File', 
    'options' => array('cache_dir' => '../cache'))), 
    // Static Page HTML Cache
    'page' => array(
    'frontend' => array('name' => 'Capture', 
    'options' => array('ignore_user_abort' => true)), 
    'backend' => array('name' => 'Static-Backend', 
    'options' => array('public_dir' => '../public'))), 
    // Tag Cache
    'pagetag' => array(
    'frontend' => array('name' => 'Core', 
    'options' => array('automatic_serialization' => true, 'lifetime' => null)), 
    'backend' => array('name' => 'File', 
    'options' => array('cache_dir' => '../cache', 'cache_file_umask' => 0644))));
    ...
    public function setTemplateOptions ($name, $options)
    {
        ...
        if (! isset($this->_optionTemplates[$name])) {
            throw new Exception(
            'A cache configuration template' . ' does not exist with the name "' .
             $name . '"');
        }
