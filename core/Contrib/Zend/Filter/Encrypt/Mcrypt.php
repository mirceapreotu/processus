...
use Zend\Filter\Exception, Zend\Filter\Compress, Zend\Filter\Decompress;
...
class Mcrypt implements EncryptionAlgorithm
{
     ...
     * )
     */
    protected $_encryption = array('key' => 'ZendFramework', 
    'algorithm' => 'blowfish', 'algorithm_directory' => '', 
    'mode' => 'cbc', 'mode_directory' => '', 'vector' => null, 
    'salt' => false);
    ...
    protected function _openCipher ()
    {
        ...
        $this->_encryption['algorithm_directory'], $this->_encryption['mode'], 
