...
use Zend\Amf\Parser\AbstractSerializer, Zend\Amf, Zend\Amf\Parser, Zend\Amf\Value, Zend\Date;
...
class Serializer extends AbstractSerializer
{
    ...
    public function writeObject ($object)
    {
        ...
        switch (true) {
            ...
            case ($className = Parser\TypeLoader::getMappedClassName(
            get_class($object))):
                break;
        ...
        if (array_key_exists($className, $this->_referenceDefinitions)) {
            ...
            'encoding' => $encoding, 'propertyNames' => $propertyNames);
