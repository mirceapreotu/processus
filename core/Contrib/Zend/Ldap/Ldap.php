...
class Ldap
{
    ...
    public function setOptions ($options)
    {
        ...
        $permittedOptions = array('host' => null, 'port' => 0, 
        'useSsl' => false, 'username' => null, 'password' => null, 
        'bindRequiresDn' => false, 'baseDn' => null, 
        'accountCanonicalForm' => null, 'accountDomainName' => null, 
        'accountDomainNameShort' => null, 'accountFilterFormat' => null, 
        'allowEmptyPassword' => false, 'useStartTls' => false, 
        'optReferrals' => false, 'tryUsernameSplit' => true);
    ...
    protected function _getAccountFilter ($acctname)
    {
        ...
        if (! $this->_getBindRequiresDn()) {
            ...
            return sprintf(
            "(&(objectClass=user)(sAMAccountName=%s))", $aname);
        }
     ...
     * @throws \Zend\Ldap\Exception
     */
    protected function _createCollection (Collection\DefaultIterator $iterator, 
    $collectionClass)
    {
    ...
    public function count ($filter, $basedn = null, $scope = self::SEARCH_SCOPE_SUB)
    {
        try {
            ...
            if ($e->getCode() === Exception::LDAP_NO_SUCH_OBJECT)
                return 0;
            else
                throw $e;
        }
    ...
    public function add ($dn, array $entry)
    {
        ...
        $adAttributes = array('distinguishedname', 'instancetype', 'name', 
        'objectcategory', 'objectguid', 'usnchanged', 'usncreated', 
    ...
    $alwaysEmulate = false)
    {
        ...
        $newDnParts = array_merge(array(array_shift($orgDnParts)), 
        $newParentDnParts);
    ...
    public function copy ($from, $to, $recursively = false)
    {
        ...
        if ($recursively === true && $this->countChildren($from) > 0) {
            ...
            foreach ($children as $c) {
                ...
                $newChildParts = array_merge(array(array_shift($cDnParts)), 
                $toDnParts);
