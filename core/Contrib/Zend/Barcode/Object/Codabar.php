...
class Codabar extends AbstractObject
{
     ...
     * @var array
     */
    protected $_codingMap = array('0' => "101010011", '1' => "101011001", 
    '2' => "101001011", '3' => "110010101", '4' => "101101001", 
    '5' => "110101001", '6' => "100101011", '7' => "100101101", 
    '8' => "100110101", '9' => "110100101", '-' => "101001101", 
    '$' => "101100101", ':' => "1101011011", '/' => "1101101011", 
    ...
    protected function _calculateBarcodeWidth ()
    {
        ...
        if (count($barcodeChar) > 1) {
            foreach ($barcodeChar as $c) {
                $encodedData += ((strlen($this->_codingMap[$c]) + 1) *
                 $this->_barThinWidth) * $this->_factor;
            }
        }
    ...
    protected function _prepareBarcode ()
    {
        ...
        foreach ($text as $char) {
            ...
            foreach ($barcodeChar as $c) {
                ...
                $barcodeTable[] = array($c, 
                $this->_barThinWidth, 0, 1);
            }
