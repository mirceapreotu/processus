...
class Pheanstalk
{
    ...
    {
        $this->_dispatch(new \Pheanstalk\Command\BuryCommand($job, $priority));
    }
    ...
    {
        $this->_dispatch(new \Pheanstalk\Command\DeleteCommand($job));
        return $this;
    }
    ...
    public function ignore($tube)
    {
        if (isset($this->_watching[$tube])) {
            $this->_dispatch(new \Pheanstalk\Command\IgnoreCommand($tube));
    ...
    {
        $response = $this->_dispatch(new \Pheanstalk\Command\KickCommand($max));
    ...
    public function listTubes()
    {
        return (array)$this->_dispatch(
            new \Pheanstalk\Command\ListTubesCommand()
        );
    }
    ...
    public function listTubesWatched($askServer = false)
    {
        if ($askServer) {
            $response        = (array)$this->_dispatch(
                new \Pheanstalk\Command\ListTubesWatchedCommand()
            );
    ...
    public function listTubeUsed($askServer = false)
    {
        if ($askServer) {
            $response     = $this->_dispatch(
                new \Pheanstalk\Command\ListTubeUsedCommand()
            );
    ...
    {
        $this->_dispatch(new \Pheanstalk\Command\PauseTubeCommand($tube, $delay));
        return $this;
    }
    ...
    {
        $response = $this->_dispatch(
            new \Pheanstalk\Command\PeekCommand($jobId)
        );
    ...
    public function peekReady($tube = null)
    {
        ...
        $response = $this->_dispatch(
            new \Pheanstalk\Command\PeekCommand(\Pheanstalk\Command\PeekCommand::TYPE_READY)
        );
    ...
    public function peekDelayed($tube = null)
    {
        ...
        $response = $this->_dispatch(
            new \Pheanstalk\Command\PeekCommand(\Pheanstalk\Command\PeekCommand::TYPE_DELAYED)
        );
    ...
    public function peekBuried($tube = null)
    {
        ...
        $response = $this->_dispatch(
            new \Pheanstalk\Command\PeekCommand(\Pheanstalk\Command\PeekCommand::TYPE_BURIED)
        );
    ...
    {
        $response = $this->_dispatch(
            new \Pheanstalk\Command\PutCommand($data, $priority, $delay, $ttr)
        );
    ...
    {
        $this->_dispatch(
            new \Pheanstalk\Command\ReleaseCommand($job, $priority, $delay)
        );
    ...
    {
        $response = $this->_dispatch(
            new \Pheanstalk\Command\ReserveCommand($timeout)
        );

        $falseResponses = array(
            \Pheanstalk\Response::RESPONSE_DEADLINE_SOON,
    ...
    {
        return $this->_dispatch(new \Pheanstalk\Command\StatsJobCommand($job));
    }
    ...
    {
        return $this->_dispatch(new \Pheanstalk\Command\StatsTubeCommand($tube));
    }
    ...
    {
        return $this->_dispatch(new \Pheanstalk\Command\StatsCommand());
    }
    ...
    {
        $this->_dispatch(new \Pheanstalk\Command\TouchCommand($job));
        return $this;
    }
    ...
    {
        if ($this->_using != $tube) {
            $this->_dispatch(new \Pheanstalk\Command\UseCommand($tube));
            $this->_using = $tube;
        }
        return $this;
    }
    ...
    {
        if (!isset($this->_watching[$tube])) {
            $this->_dispatch(new \Pheanstalk\Command\WatchCommand($tube));
     ...
     * re-attempted once.
     *
     * @param \Pheanstalk\Command $command
     *
     * @return \Pheanstalk\Response
     */
