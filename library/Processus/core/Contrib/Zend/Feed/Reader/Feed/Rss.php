...
class Rss extends AbstractFeed
{
    ...
    public function __construct (\DomDocument $dom, $type = null)
    {
        ...
        $dublinCoreClass = Reader\Reader::getPluginLoader()->getClassName(
        'DublinCore\Feed');
        $this->_extensions['DublinCore\Feed'] = new $dublinCoreClass($dom, 
        $this->_data['type'], $this->_xpath);
        $atomClass = Reader\Reader::getPluginLoader()->getClassName(
        'Atom\\Feed');
        $this->_extensions['Atom\Feed'] = new $atomClass($dom, 
        $this->_data['type'], $this->_xpath);
