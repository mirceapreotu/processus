...
use Zend\Amf\Parser\AbstractSerializer, Zend\Amf\Parser, Zend\Amf, Zend\Date;
...
class Serializer extends AbstractSerializer
{
    ...
    protected function getClassName ($object)
    {
        ...
        switch (true) {
            ...
            case Parser\TypeLoader::getMappedClassName(
            get_class($object)):
                $className = Parser\TypeLoader::getMappedClassName(
                get_class($object));
                break;
