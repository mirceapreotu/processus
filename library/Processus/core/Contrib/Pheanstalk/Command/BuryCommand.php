 ...
 */
class Pheanstalk_Command_BuryCommand extends Pheanstalk_Command_AbstractCommand implements 
Pheanstalk_ResponseParser
{
    ...
    {
        return sprintf('bury %d %d', $this->_job->getId(), $this->_priority);
    }
    ...
    public function parseResponse ($responseLine, $responseData)
    {
        if ($responseLine == Pheanstalk_Response::RESPONSE_NOT_FOUND) {
            ...
            sprintf('%s: Job %d is not reserved or does not exist.', 
